...
try{
	...
	$response=file_get_contents("https://www.google.com/recaptcha/api/siteverify?secret=".$secretKey."&response=".$captcha."&remoteip=".$ip);
		...
		//$mail->AddAddress('arenera@yahoo.com', 'Fabian');	
		$mail->AddAddress('areneradelpuerto@yahoo.com', 'Fabian');					//Email y nombre RECEPTOR
...
<head>
	<meta charset="utf-8">
	<meta name="google-site-verification" content="_iEqgK5YIZ8X0_innloi5hTgbgC0GF_3dyP5H4ICwss" />
	<meta name="viewport" content="width=device-width">
	<meta property="og:type" content="article" />
	<meta property="og:image" content="https://www.areneradelpuerto.com.ar/img/areneraLogo.png" />
	<meta property="og:image:alt" content="Logo Arenera del Puerto" />
	<meta property="og:description" content="Arenera del Puerto está ubicada en la ciudad de San Pedro, Prov. de Buenos Aires. Inició sus actividades en el año 1967. En la actualidad, la empresa tiene una capacidad de producción propia de 30.000 toneladas mensuales." />
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-CV7P0FMY4M"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
			gtag('js', new Date());
			gtag('config', 'G-CV7P0FMY4M');
	</script>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="img/extraccion.JPG" alt="Extracción de arena">
			...
			<div class="item">
				<img src="img/descarga.JPG" alt="Descarga de arena">
				<div class="carousel-caption">
			...
			<div class="item">
				<img src="img/bombeo.JPG" alt="Bombeo a silos">
				<div class="carousel-caption">
			...
			<div class="item">
				<img src="img/secado.JPG" alt="Secado de arena">
				<div class="carousel-caption">
			...
			<div class="item">
				<img src="img/carga.JPG" alt="Carga de camiones">
				<div class="carousel-caption">
			...
			<div class="item">
				<img src="img/pesaje.JPG" alt="Pesaje con balanza">
				<div class="carousel-caption">
...
<section class="ubicacion-section" id="ubicacion">
	<h2>UBICACIÓN</h2>
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3319.89376862123!2d-59.64367928483839!3d-33.685814780707275!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95ba3ce9ece204f9%3A0x28d7037d62122251!2sARENERA%20DEL%20PUERTO%20SA%20San%20Pedro!5e0!3m2!1ses-419!2sar!4v1609960332079!5m2!1ses-419!2sar" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
</section>
...
<footer>
	<div class="contacto-datos">
		<h3>Arenera del Puerto S.A</h3><br>
	...
	<div class="footer-copyright text-center py-3">
		<span class="font-weight-bold"><i class="far fa-copyright"></i>  Bassi Capurro, Manuel </span>
	</div>
</footer>
